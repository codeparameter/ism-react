...
export default function BlockDetails() {
    ...
    return <>
      ...
      {/*<!-- breadcrumb-area -->*/}
      <section className="breadcrumb-area breadcrumb-bg" data-background="/assets/img/bg/breadcrumb_bg.jpg" style={{backgroundImage: "url(/assets/img/bg/breadcrumb_bg.jpg)"}}>
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="breadcrumb-content">
                                <h2 className="title">برگه تکی نمونه کار</h2>
                                <nav aria-label="breadcrumb">
                                    <ol className="breadcrumb">
                                        <li className="breadcrumb-item"><a href="index.html">خانه</a></li>
                                        <li className="breadcrumb-item active" aria-current="page">جزئیات نمونه کار</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
